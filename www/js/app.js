...
app
  ...
  .controller('setCtrl', function ($scope, $ionicModal, $translate) {
    ...
    $scope.accountCBChange = function () {
      console.log('accountCB Change', $scope.accountCB.checked);
      if ($scope.accountCB.checked)
        window.localStorage.setItem("accountCB", 'on');
      else
        window.localStorage.setItem("accountCB", 'off');
    };
    ...
    $scope.autoGeoCBChange = function () {
      console.log('autoGeoCB Change', $scope.autoGeoCB.checked);
      if ($scope.autoGeoCB.checked)
        window.localStorage.setItem("autoGeoCB", 'on');
      else
        window.localStorage.setItem("autoGeoCB", 'off');
    };
    ...
    $scope.langs = [{
      ...
      name: "English",
      val: "en",
      info: "Please shut down the app and restart it."
    }];
