...
function showSkywatch_wind(){
    ...
    function onData(buffer){
        var sw_w = (new Uint16Array(buffer))[0]*0.01;
...
function showSkywatch_temp(){
    ...
    function onData(buffer){
        var sw_t = (new Uint16Array(buffer))[0]*0.01;
...
function showSkywatch_humd(){
    ...
    function onData(buffer){
        var sw_h = (new Uint16Array(buffer))[0]*0.01;
...
function showSkywatch_pres(){
    ...
    function onData(buffer){
        var sw_p = (new Uint32Array(buffer))[0]*0.001;
